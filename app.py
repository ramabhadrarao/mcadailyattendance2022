...
if check_password():
        ...
        if choose == "Logout":
              ...
              st.markdown("<a href='https://share.streamlit.io/ramabhadrarao/mcadailyattendance2022/main/app.py' target='_self'>Click Here to Login Again</a>", unsafe_allow_html=True)  
